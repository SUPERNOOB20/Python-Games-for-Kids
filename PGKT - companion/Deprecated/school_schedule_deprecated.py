...
def add_ingredients(*argumentos, **argumentos_clave):
    for argumento in argumentos:    # argumento = [str]
...
# Makes the schedule for Monday.
make_schedule[0] = ["P.E", "Art", "Maths"]

# Makes the schedule for Tuesday.
make_schedule[1] = []

# Makes the schedule for Wednesday.
make_schedule[2] = []
