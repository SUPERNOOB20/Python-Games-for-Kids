...
height = user_screen_width / true_scale_factor_height

images: dict = pygame_utils.creates_images({cars_scaled_surface: ["cars.png", width, height],
                                            base_scaled_surface: ["base.png", width, height],
                                            red_light_scaled_surface: ["red_light.png", width, height],
                                            green_light_scaled_surface: ["green_light.png", user_screen_width / true_scale_factor_width, user_screen_height / true_scale_factor_height],
                                            post_scaled_surface:["post.png"],
                                            background_scaled_surface:["background.png"], })
