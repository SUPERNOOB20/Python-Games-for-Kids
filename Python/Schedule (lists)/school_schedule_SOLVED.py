...
monday_schedule = ["P.E", "Art", "Maths", "Maths", "Chemistry"]
tuesday_schedule = ["Literature", "Literature", "Art", "English", ""]
wednesday_schedule = ["P.E", "I.T", "Geography", "English", ""]                            
thursday_schedule = ["Chemistry", "I.T", "Geography", "English", "French"]
friday_schedule = ["Literature", "Literature", "Geography", "English", "Chemistry"]
